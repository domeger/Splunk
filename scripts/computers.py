#!/usr/bin/env python
"""
A script for fetching and printing every device on a Code42 installation in
...
def _setup_args(arg_parser):
    ...
    :return:           The argparse.ArgumentParser object with arguments
                       added to it.
    """
    arg_parser.add_argument('--backup-usage',
                            dest='backup',
                            action='store_true',
                            help='Include backup usage and backup history info.')
